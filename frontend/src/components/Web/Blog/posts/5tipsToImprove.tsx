        ...
        <p>
          <Trans
            ...
            components={{
              a: (
                <a
                  href="https://www.linkedin.com/posts/carme-alcoverro_participaciaejn-tips-improve-activity-7132336250392330240-Y9nv/?utm_source=share&utm_medium=member_desktop"
                  target="_blank"
                  rel="noreferrer"
                />
              )
