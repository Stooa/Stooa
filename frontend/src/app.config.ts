...
export const ROUTE_SIGN_IN = '/log-in';
export const ROUTE_REGISTER = '/register';
export const ROUTE_FISHBOWL = '/fb';
export const ROUTE_FISHBOWL_CREATE = '/fishbowl/create';
export const ROUTE_FISHBOWL_FINISHED = '/fishbowl/finished';
export const ROUTE_FISHBOWL_SCHEDULED = '/fishbowl/scheduled';
...
export const ROUTE_USER_NO_PARTICIPATING = '/user-not-participating';
...
export const ROUTE_HUBSPOT = '/hubspot';
export const ROUTE_HUBSPOT_RETURN = '/integrations';
