...
{
    public function __construct(private readonly CreateTranscriptionThreadService $threadsService)
    {
    ...
    {
        return new JsonResponse(['response' => $this->threadsService->createThread($threadId)]);
    }
}
